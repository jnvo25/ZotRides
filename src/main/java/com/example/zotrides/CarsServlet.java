...
public class CarsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String query = "SELECT Cars.id as id, model, make, year, name, rating, numVotes, address, phoneNumber FROM ((((Cars JOIN category_of_car ON Cars.id = category_of_car.carID) JOIN Category ON categoryID = Category.id) JOIN Ratings ON Cars.id = Ratings.carID) JOIN pickup_car_from ON Cars.id = pickup_car_from.carID) JOIN PickupLocation ON pickup_car_from.pickupLocationID = PickupLocation.id ORDER BY -1*rating;";
